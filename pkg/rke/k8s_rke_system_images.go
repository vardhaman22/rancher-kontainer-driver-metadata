...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.30.0-rancher1-1": {
			Etcd:                      "rancher/mirrored-coreos-etcd:v3.5.12",
			Kubernetes:                "vardhaman123/hyperkube:v1.30.0-rancher1",
			Alpine:                    "vardhaman123/rancher-rke-tools:v0.1.97",
			NginxProxy:                "vardhaman123/rancher-rke-tools:v0.1.97",
			CertDownloader:            "vardhaman123/rancher-rke-tools:v0.1.97",
			KubernetesServicesSidecar: "vardhaman123/rancher-rke-tools:v0.1.97",
			KubeDNS:                   "registry.k8s.io/dns/k8s-dns-kube-dns:1.23.0",
			DNSmasq:                   "registry.k8s.io/dns/k8s-dns-dnsmasq-nanny:1.23.0",
			KubeDNSSidecar:            "registry.k8s.io/dns/k8s-dns-sidecar:1.23.0",
			KubeDNSAutoscaler:         "rancher/mirrored-cluster-proportional-autoscaler:v1.8.9",
			Flannel:                   "rancher/mirrored-flannel-flannel:v0.25.1",
			FlannelCNI:                "rancher/flannel-cni:v1.4.1-rancher1",
			CalicoNode:                "rancher/mirrored-calico-node:v3.28.0",
			CalicoCNI:                 "vardhaman123/calico-cni:v3.28.0-rancher1",
			...
			CanalCNI:                  "vardhaman123/calico-cni:v3.28.0-rancher1",
			...
			CoreDNSAutoscaler:         "rancher/mirrored-cluster-proportional-autoscaler:v1.8.9",
			WindowsPodInfraContainer:  "rancher/mirrored-pause:3.7",
			Nodelocal:                 "registry.k8s.io/dns/k8s-dns-node-cache:1.23.0",
		},
