...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.28.7-rancher1-2": {
			Etcd:                      "rancher/mirrored-coreos-etcd:v3.5.10",
			Kubernetes:                "rancher/hyperkube:v1.28.7-rancher1",
			Alpine:                    "vardhaman123/rancher-rke-tools:v1.0.4",
			NginxProxy:                "vardhaman123/rancher-rke-tools:v1.0.4",
			CertDownloader:            "vardhaman123/rancher-rke-tools:v1.0.4",
			KubernetesServicesSidecar: "vardhaman123/rancher-rke-tools:v1.0.4",
			KubeDNS:                   "rancher/mirrored-k8s-dns-kube-dns:1.22.28",
			DNSmasq:                   "rancher/mirrored-k8s-dns-dnsmasq-nanny:1.22.28",
			KubeDNSSidecar:            "rancher/mirrored-k8s-dns-sidecar:1.22.28",
			KubeDNSAutoscaler:         "rancher/mirrored-cluster-proportional-autoscaler:1.8.6",
