...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.27.5-rancher1-1": {
			...
			Alpine:                    "vardhaman123/rancher-rke-tools:latest",
			NginxProxy:                "vardhaman123/rancher-rke-tools:latest",
			CertDownloader:            "vardhaman123/rancher-rke-tools:latest",
			KubernetesServicesSidecar: "vardhaman123/rancher-rke-tools:latest",
			KubeDNS:                   "rancher/mirrored-k8s-dns-kube-dns:1.22.20",
			DNSmasq:                   "rancher/mirrored-k8s-dns-dnsmasq-nanny:1.22.20",
			KubeDNSSidecar:            "rancher/mirrored-k8s-dns-sidecar:1.22.20",
			KubeDNSAutoscaler:         "rancher/mirrored-cluster-proportional-autoscaler:1.8.6",
