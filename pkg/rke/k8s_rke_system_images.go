...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.30.2-rancher1-1": {
			...
			Alpine:                    "vardhaman123/rke-tools:v0.1.99",
			NginxProxy:                "vardhaman123/rke-tools:v0.1.99",
			CertDownloader:            "vardhaman123/rke-tools:v0.1.99",
			KubernetesServicesSidecar: "vardhaman123/rke-tools:v0.1.99",
