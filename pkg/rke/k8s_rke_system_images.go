...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.27.15-rancher1-1": {
			...
			Alpine:                    "vardhaman123/rke-tools:v0.1.96",
			NginxProxy:                "vardhaman123/rke-tools:v0.1.96",
			CertDownloader:            "vardhaman123/rke-tools:v0.1.96",
			KubernetesServicesSidecar: "vardhaman123/rke-tools:v0.1.96",
			KubeDNS:                   "rancher/mirrored-k8s-dns-kube-dns:1.22.28",
			DNSmasq:                   "rancher/mirrored-k8s-dns-dnsmasq-nanny:1.22.28",
			KubeDNSSidecar:            "rancher/mirrored-k8s-dns-sidecar:1.22.28",
			KubeDNSAutoscaler:         "rancher/mirrored-cluster-proportional-autoscaler:v1.8.9",
