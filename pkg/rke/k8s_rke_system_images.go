...
func loadK8sRKESystemImages() map[string]v3.RKESystemImages {
	return map[string]v3.RKESystemImages{
		...
		"v1.30.3-rancher1-1": {
			...
			Alpine:                    "vardhaman123/rke-tools:v0.1.101",
			NginxProxy:                "vardhaman123/rke-tools:v0.1.101",
			CertDownloader:            "vardhaman123/rke-tools:v0.1.101",
			KubernetesServicesSidecar: "vardhaman123/rke-tools:v0.1.101",
			KubeDNS:                   "rancher/mirrored-k8s-dns-kube-dns:1.23.0",
			DNSmasq:                   "rancher/mirrored-k8s-dns-dnsmasq-nanny:1.23.0",
			KubeDNSSidecar:            "rancher/mirrored-k8s-dns-sidecar:1.23.0",
			KubeDNSAutoscaler:         "rancher/mirrored-cluster-proportional-autoscaler:v1.8.9",
