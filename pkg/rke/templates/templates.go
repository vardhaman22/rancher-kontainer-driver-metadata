...
func LoadK8sVersionedTemplates() map[string]map[string]string {
	return map[string]map[string]string{
		...
		kdm.NginxIngress: {
			...
			">=1.24.10-rancher1-1 <1.25.15-rancher1-1": nginxIngressv151Rancher2,
			">=1.25.15-rancher1-1 <1.26.0-rancher1-1":  nginxIngressv194Rancher1,
			">=1.26.0-rancher1-1 <1.26.10-rancher1-1":  nginxIngressv170Rancher1,
			">=1.26.10-rancher1-1 <1.27.0-rancher1-1":  nginxIngressv194Rancher1,
			">=1.27.0-rancher1-1 <1.27.7-rancher1-1":   nginxIngressv181Rancher1,
			">=1.27.7-rancher1-1":                      nginxIngressv194Rancher1,
		},
		kdm.Nodelocal: {
